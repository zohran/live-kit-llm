...
const generateLiveKitToken = async (participantName: string, roomName: string, metadata: string) => {
...
app.get('/getLiveKitToken', async (req: any, res: any) => {
    const { userName, roomName, metadata } = req.query as { userName: string; roomName: string, metadata: string };
